...
class SO100Task(base.Task):
    ...
    def get_qpos(physics):
        ...
        # right_arm_qpos = right_qpos_raw[:6]
        left_gripper_qpos = [normalize_puppet_gripper_position(left_qpos_raw[SO100Task.ARM_DOF])]
        # right_gripper_qpos = [normalize_puppet_gripper_position(right_qpos_raw[6])]
    ...
    def get_qvel(physics):
        ...
        # right_arm_qvel = right_qvel_raw[:6]
        left_gripper_qvel = [normalize_puppet_gripper_velocity(left_qvel_raw[SO100Task.ARM_DOF])]
        # right_gripper_qvel = [normalize_puppet_gripper_velocity(right_qvel_raw[6])]
